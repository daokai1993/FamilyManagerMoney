	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lvinfo.setOnItemClickListener(new OnItemClickListener()// 为ListView添加项单击事件
		{
			...
			//	String strInfo = String.valueOf(((TextView) view).getText());// 记录单击的项信息
				String strInfo = String.valueOf(((TextView)((RelativeLayout)view).getChildAt(0)).getText());// 记录收入信息
...
//				android.R.layout.simple_list_item_1, strInfos);
		arrayAdapter = new ArrayAdapter<String>(this , R.layout.listview_item , R.id.title , strInfos) ;
